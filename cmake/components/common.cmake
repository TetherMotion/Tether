...
set(TETHER_COMMON_HEADERS
    ...
    # Generated by configure_file() into the build tree — it is intentionally
...
foreach(_tgt IN LISTS _variants)
    target_include_directories(${_tgt}
        PUBLIC
            # Generated include dir (TetherConfig.hpp) comes FIRST so the
            # configure_file() output always wins over any stale copy in the
            # source tree. CMAKE_CURRENT_BINARY_DIR is correct under
            # add_subdirectory(); CMAKE_BINARY_DIR would point at the outer
            # project's build dir.
