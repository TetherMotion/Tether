...
if(TETHER_ETHERCAT_SLAVE_SOURCES)
    add_library(tether_ethercat_slave STATIC ${TETHER_ETHERCAT_SLAVE_SOURCES})
add_library(tether::ethercat_slave ALIAS tether_ethercat_slave)

    target_include_directories(tether_ethercat_slave
        PUBLIC
    ...
    target_link_libraries(tether_ethercat_slave
        PUBLIC tether_common tether_hal tether_ethercat_common
    )

    set_target_properties(tether_ethercat_slave PROPERTIES
