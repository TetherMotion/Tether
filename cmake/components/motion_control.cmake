...
# Create the motion control library
add_library(tether_motion_control STATIC ${TETHER_MOTION_CONTROL_SOURCES_FILTERED})
add_library(tether::motion_control ALIAS tether_motion_control)

target_include_directories(tether_motion_control
    PUBLIC
...
target_link_libraries(tether_motion_control
    PUBLIC tether_common tether_controls
)

set_target_properties(tether_motion_control PROPERTIES
