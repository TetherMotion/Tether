...
enum class ALStatusCode : uint16_t {
    ...
    InvalidDCLatchConfig        = 0x0031,
    PLLError                    = 0x0032,
    DCSyncIOError               = 0x0033,
    DCSyncTimeoutError          = 0x0034,
    InvalidDCCycleTime          = 0x0035,
    InvalidDCSync0Time          = 0x0036,
    InvalidDCSync1Time          = 0x0037,
    MBoxAoE                     = 0x0041,
    MBoxEoE                     = 0x0042,
    MBoxCoE                     = 0x0043,
    MBoxFoE                     = 0x0044,
    ...
    VendorSpecificStart         = 0x8000,
    Unknown                     = 0xFFFF,

    // Aliases kept for compatibility with the former constants namespace
    // in Reset.hpp (same underlying values).
    InvalidStateChange          = InvalidRequestedStateChange,
    UnknownStateRequested       = UnknownRequestedState,
    BootNotSupported            = BootstrapNotSupported,
    InvalidSMConfig             = InvalidSyncManagerConfig,
    SyncError                   = SynchronizationError,
    SMWatchdog                  = SyncManagerWatchdog,
    InvalidSMTypes              = InvalidSyncManagerTypes,
    SyncNotSupported            = SyncModeNotSupported,
    NoValidInputsOutputs        = NoValidInputsAndOutputs,
    MBXAoeError                 = MBoxAoE,
    MBXEoeError                 = MBoxEoE,
    MBXCoeError                 = MBoxCoE,
    MBXFoeError                 = MBoxFoE,
