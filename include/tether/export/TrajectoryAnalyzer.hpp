...
public:
    virtual ~ApproximationStrategy() = default;
...
public:
    const char* name() const override { return "FixedTime"; }
...
public:
    const char* name() const override { return "FixedDeviation"; }
...
public:
    const char* name() const override { return "SCurve"; }
