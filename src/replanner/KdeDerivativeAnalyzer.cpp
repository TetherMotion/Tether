...
KdeDerivativeAnalyzer::DependenceMetrics KdeDerivativeAnalyzer::computeDependence(
    const std::vector<double>& x,
    ...
    if (sxx > 1e-15 && syy > 1e-15) {
        dep.pearson = sxy / std::sqrt(sxx * syy);
    }
